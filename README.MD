...
<details>
	...
	- TODO: Make increase max target number glyphs actually work for archer/sorc, probably never
	- TODO: Make there be a timeout so that if an enemy hasn't been seen in a long time we reset their location, maybe?
